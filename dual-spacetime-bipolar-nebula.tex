...
\author{
  Hypernumber Research Collective\\[4pt]
  \small In close collaboration with Grok 4 (xAI)\\
  \small \texttt{https://github.com/hypernumbernet}
}
...
The parameter space for binary torsion-star formation is shown to be surprisingly wide, explaining why $\gtrsim 50\%$ of all planetary nebulae exhibit pronounced bipolar or multipolar structure.  
...
\]
This range covers $\gtrsim70\%$ of all core-collapse events, consistent with the observed $\sim50-60\%$ fraction of non-spherical planetary nebulae.
